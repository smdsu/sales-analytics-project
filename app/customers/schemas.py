...
class SCustomer(BaseModel):
    ...
    date_of_birth: date = Field(
        ...,
        description="Дата рождения клиента в формате ГГГГ-ММ-ДД"
    )
    ...
    created_at: datetime = Field(
        ...,
        description="Время создания записи в таблице"
    )
    updated_at: datetime = Field(
        ...,
        description="Время обноввления записи в таблице"
    )
...
class SCustomerUpd(BaseModel):
    ...
    first_name_new: Optional[str] = Field(
        None,
        description="Имя клиента"
    )
    last_name_new: Optional[str] = Field(
        None,
        description="Фамилия клиента"
    )
    date_of_birth_new: Optional[date] = Field(
        None,
        description="Дата рождения клиента в формате ГГГГ-ММ-ДД"
    )
    email_new: Optional[EmailStr] = Field(
        None,
        description="Электронная почта клиента"
    )
